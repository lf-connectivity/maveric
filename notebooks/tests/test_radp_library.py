...
class TestMobilityRobustnessOptimization(unittest.TestCase):
    ...
    def test_find_sim_boundary(self):
        ...
        expected_min_lat = -100.00  # min(-90.00, 0.00, 90.00, 59.80, 54.85, -20.24, -38.10) - 10
        expected_max_lat = 100.00  # max(-90.00, 0.00, 90.00, 59.80, 54.85, -20.24, -38.10) + 10
        expected_min_lon = -190.00  # min(-180.00, 0.00, 180.00, -22.63, 119.76, 72.11, -67.52) - 10
        expected_max_lon = 190.00  # max(-180.00, 0.00, 180.00, -22.63, 119.76, 72.11, -67.52) + 10
        ...
        self.assertAlmostEqual(bounds_empty["min_lat"], expected_min_lat_empty, places=2)
        self.assertAlmostEqual(bounds_empty["max_lat"], expected_max_lat_empty, places=2)
        self.assertAlmostEqual(bounds_empty["min_lon"], expected_min_lon_empty, places=2)
        self.assertAlmostEqual(bounds_empty["max_lon"], expected_max_lon_empty, places=2)
        ...
        self.assertAlmostEqual(bounds_small["min_lat"], expected_min_lat_small, places=2)
        self.assertAlmostEqual(bounds_small["max_lat"], expected_max_lat_small, places=2)
        self.assertAlmostEqual(bounds_small["min_lon"], expected_min_lon_small, places=2)
        self.assertAlmostEqual(bounds_small["max_lon"], expected_max_lon_small, places=2)
