...
class EnergySavingVisualizer:
    """
    The visualization of network performance is performed by this class, in which a baseline configuration is compared to an RL-optimized configuration.
    """
    def __init__(self, bdt_model_path: str, rl_model_path: str, topology_path: str, config_path: str, base_ue_data_dir: str):
        ...
        self.COL_CELL_ID = getattr(c, 'CELL_ID', 'cell_id'); self.COL_UE_ID = 'mock_ue_id' # Alignment with generated data is ensured
    ...
    def _plot_scenario(self, ax, title: str, ue_data: pd.DataFrame, attached_data: pd.DataFrame,
        ...
        # It is ensured that only non-empty dataframes are plotted
