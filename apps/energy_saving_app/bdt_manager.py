...
# This module is intended to manage the training process of the Bayesian Digital Twin (BDT) model and to facilitate the downloading of the resulting model artifact.
import os
import sys
import subprocess
import logging
...
class BDTManager:
    """
    The management of the training process for the Bayesian Digital Twin model, as well as the downloading of the resulting model, is performed by this class.
    """
    ...
    def _download_model_from_container(self, model_id: str, container_name: str):
        # The downloading of the trained model file from the specified Docker container to the local file system is performed by this method.
