...
class TestBayesianDigitalTwin(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Test data loss_vs_iter generated with seed_everything(1)
        cls.loss_vs_iter = {
            "Cell1": [
                1.3360857963562012,
                1.3250646591186523,
        ...
        # Test data MEA and MAPE generated with seed_everything(1)
        cls.MEA = {"Cell1": 1.7881388210634555, "Cell2": 0.07000514313754991, "Cell3": 0.07576626164573952}
        cls.MAPE = {"Cell1": 2.384185094751274, "Cell2": 0.07000514313754991, "Cell3": 0.09590666031106268}
    ...
    def test_rf_bayesian_digital_twin(self):
        ...
        for cell_id, training_data in cell_id_training_data_map.items():
            ...
            expected_loss_vs_iter = self.loss_vs_iter[cell_id]
            self.assertEqual(loss_vs_iter.tolist(), expected_loss_vs_iter)
        ...
        for cell_id, testing_data in cell_id_test_data_map.items():
            ...
            EXPECTED_MAE = self.MEA[cell_id]
            self.assertEqual(MAE, EXPECTED_MAE)

            EXPECTED_MAPE = self.MAPE[cell_id]
